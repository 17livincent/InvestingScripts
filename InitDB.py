...
INSERT_STATEMENT_FUNDAMENTALS = text(
    "INSERT INTO {} (ticker, "
    "date, "
    "total_revenue, "
    "cost_of_revenue, "
...
INSERT_STATEMENT_OPERATIONAL_METRICS = text(
    "INSERT INTO {} (ticker, "
    "date,"
    "roic,"
    "roe,"
...
INSERT_STATEMENT_SHARES_OUTSTANDING = text(
    "INSERT INTO {} (ticker, "
    "date, "
    "basic_shares,"
    "diluted_shares)"
...
INSERT_STATEMENT_PRICES_WEEKLY = text(
    "INSERT INTO {} (ticker, "
    "date, "
    "adjusted_close, "
    "volume)"
...
INSERT_STATEMENT_VALUATION_METRICS = text(
    "INSERT INTO {} (ticker, "
    "date,"
    "market_cap,"
    "enterprise_value,"
